 ...
 */
    ...
    #define LCD_GPIO_ChipSelect     GPIO_90 // PB4
    ...
    #define GSM_GPIO_PWRKEY         GPIO_30 // PA5
    #define GSM_GPIO_RESET          GPIO_31 // PA6
    #define GSM_GPIO_PSM_EINT       GPIO_29 // PA4
    #define GSM_GPIO_RI             GPIO_32 // PA7
